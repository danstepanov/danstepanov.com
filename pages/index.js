  ...
  return (
    <Container>
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <ProjectCard title="Slice Capital (acquired)" description="SEC and FINRA-approved funding platform providing startup investment to the masses." href="https://pitchbook.com/profiles/company/121401-01#overview" icon="slice" />
        <Timeline />
      </div>
    </Container>
  )
